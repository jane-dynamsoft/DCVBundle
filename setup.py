...
id_utility_lib_name = 'DynamsoftIdentityUtility'
...
if sys.platform == "linux" or sys.platform == "linux2":
    ...
    id_utility_lib_name = 'DynamsoftIdentityUtilityx64'
    lib_dir = 'lib/win'
...
if sys.platform == "linux" or sys.platform == "linux2" or sys.platform == "darwin":
    ...
    module_id_utility = Extension('_DynamsoftIdentityUtility', ['src/DynamsoftIdentityUtility_wrap.cxx'], libraries = [id_utility_lib_name,core_lib_name], **ext_args)
    ...
    module_id_utility = Extension('_DynamsoftIdentityUtility', ['src/DynamsoftIdentityUtility_wrap.cxx'],include_dirs=['include'], library_dirs=[lib_dir],libraries=[id_utility_lib_name,core_lib_name])
...
setup (name = 'dynamsoft_capture_vision_bundle',
        ...
        ext_modules = [module_core,module_cvr,module_dbr,module_dcp,module_dcpd,module_ddn,module_dip,module_dlr,module_license,module_utility, module_id_utility],
